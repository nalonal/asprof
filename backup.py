...
def start_count_total():
	...
	print()
	# time.sleep(20)
	# total_ieee = driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div[3]/div/xpl-root/div/xpl-search-results/main/div[1]/div[2]/xpl-search-dashboard/section/div/h1/span[1]')
	# print(total_ieee.text)
